...
#import "CaptureDCPathItemButton.h"

@import UIKit;
@import QuartzCore;

@class CaptureDCPathButton;
 ...
 */
- (void)willPresentDCPathButtonItems:(CaptureDCPathButton *)dcPathButton;
/*!
 ...
 */
- (void)willDismissDCPathButtonItems:(CaptureDCPathButton *)dcPathButton;
/*!
 ...
 */
- (void)didDismissDCPathButtonItems:(CaptureDCPathButton *)dcPathButton;

@end

@interface CaptureDCPathButton : UIView <UIGestureRecognizerDelegate>

/*!
 *  The object that acts as the delegate of the `DCPathButton` object.
 */
@property (retain, nonatomic) id<DCPathButtonDelegate> delegate;
